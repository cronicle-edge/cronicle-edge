...
if (process.env['CRONICLE_sqlite']) { // use sqlite
	...
	process.env["CRONICLE_Storage__engine"] = "SQL"
	process.env["CRONICLE_Storage__SQL__client"] = map[cs['protocol']]
	...
	process.env["CRONICLE_Storage__SQL__connection__port"] = parseInt(cs['port'])
	...
	process.env["CRONICLE_Storage__SQL__connection__port"] = parseInt(process.env['CRONICLE_postgres_port'])
