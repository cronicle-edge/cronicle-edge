...
module.exports = Class.create({
	...
	scrubStartupEnvSecrets: function(env) {
		[
			"CRONICLE_secret_key",
			"CRONICLE_oauth__client_secret",
			"CRONICLE_Storage__AWS__secretAccessKey",
			"CRONICLE_Storage__AWS__sessionToken",
			"CRONICLE_Storage__AWS__credentials__secretAccessKey",
			"CRONICLE_Storage__AWS__credentials__sessionToken",
			"CRONICLE_Storage__SQL__connection__password",
			"CRONICLE_Storage__Sftp__connection__password",
			"CRONICLE_Storage__Redis__password",
			"CRONICLE_Storage__RedisCluster__password",
			"CRONICLE_sqlstring",
			"CRONICLE_password",
			"CRONICLE_postgres_password"
	...
	startup: function (callback) {
		...
		// Configuration has already been loaded, so clear credentials before any
		// plugin process can inherit the daemon environment.
		this.scrubStartupEnvSecrets(process.env);
