...
Class.subclass(Page.Base, "Page.JobDetails", {
	...
	receive_details: function (resp) {
      ...
      html +=
        '<div style="background-color:black;color:#f2f2f2;background-image: radial-gradient(rgba(48, 48, 48, 1), black 300%);font: 1rem Inconsolata, monospace;"><pre id="console_output"></pre></div>';
      ...
      function trimAnimation(line) { //
        ...
        if (line.trimEnd().indexOf("\r") > -1) return line.substring(line.trimEnd().indexOf("\r"));
        return line;
      }
