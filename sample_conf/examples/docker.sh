...
# Postgres:
docker run -d --name postgres -e POSTGRES_PASSWORD='P@ssword' -p 5432:5432 -d postgres

# Mysql
docker run -d --name mysql -p 3306:3306 -e MYSQL_DATABASE=cronicle -e MYSQL_ROOT_PASSWORD='P@ssword'  mysql
